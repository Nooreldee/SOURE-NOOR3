...
LuaTele = luatele.set_config{api_id=21911480,api_hash='b8ababdddc7ab2a226c6eac5ffe07d2f',session_name=NASA,token=Token}
function var(value)
...
send(msg.chat_id,msg.id,"*◍ اهلاً بك عـزيـري الـمـطور عمر* \n","md",true, false, false, true, reply_markup)
return false 
end
...
data = {
{
{text = '👤 | مبرمج السورس', url = 't.me/N_O0_R'}, 
},
{
{text = '🔘 | قناة السورس ', url = 't.me/source_noor'}, 
},
}
}
...
{
{text = '☢️ | اضغط هنا لتنصيب', url = 't.me/noor_protic_bot'}, 
},
{
{text = '🔘 | قناة السورس', url = 't.me/source_noor'}, 
},
...
{{text = '- اخفاء الامر ', data =msg.sender_id.user_id..'/delAmr'},},}}
 send(msg.chat_id,msg.id,"https://telegra.ph/file/1859cca4fc103cea7f80a.jpg","html",false, false, false, false, reply_markup)
end
